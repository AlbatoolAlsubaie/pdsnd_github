...
def get_filters():
    ...
    month = input('which month would you like?').lower()
    while month not in ['all','january', 'february', 'march', 'april', 'may', 'june']:
        month = input('You can choose january, february, ... , june : ').lower()

    # get user input for day of week (all, monday, tuesday, ... sunday)
    while True:
        day = input("Please choose a day or write all for all days")
        day = day.lower()
